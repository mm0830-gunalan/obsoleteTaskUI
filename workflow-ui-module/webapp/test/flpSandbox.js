		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ObsoleteTaskForm",
									"targetURL": "#obsoletetaskformworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"obsoletetaskformworkflowuimodule-display": {
								"semanticObject": "obsoletetaskformworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=obsoletetaskform.workflowuimodule",
									"url": sap.ui.require.toUrl("obsoletetaskform/workflowuimodule")
								}
							}
						}
					}
